...
export const Footer: React.FC = () => {
  return (
    <footer className="py-12 px-6 border-t border-slate-200 dark:border-slate-800 bg-gradient-to-b from-transparent to-slate-50/50 dark:to-slate-900/50">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <motion.div 
          ...
          className="flex gap-8 text-[10px] font-black text-slate-400 uppercase tracking-widest"
        >
          <Link 
            href="/privacy" 
